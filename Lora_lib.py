#############################################################################################
# EBYTE LoRa E220 Series for Raspberry Pi - MODIFIED FOR PC
#
# ORIGINAL AUTHOR: Renzo Mischianti
# ORIGINAL VERSION: 0.0.1
# MODIFIED VERSION: 0.0.2
#
# LICENSE: MIT
#
...
#
# This version has been modified to work on PC with a LoRa module via serial connection.
#
# All original rights of Renzo Mischianti are respected.
#############################################################################################


try:
    from lora_e220_constants import UARTParity, UARTBaudRate, TransmissionPower, FixedTransmission, \
        AirDataRate, OperatingFrequency, LbtEnableByte, WorPeriod, RssiEnableByte, RssiAmbientNoiseEnable, SubPacketSetting
    ...
    # Dummy constants/classes per evitare NameError
    class UARTParity:
        MODE_00_8N1 = None
    class UARTBaudRate: pass
    class TransmissionPower: pass
    class FixedTransmission: pass
    class AirDataRate: pass
    class OperatingFrequency: pass
    class LbtEnableByte: pass
    class WorPeriod: pass
    class RssiEnableByte: pass
    class RssiAmbientNoiseEnable: pass
    class SubPacketSetting: pass

    class ResponseStatusCode: pass
    class ModeType: pass
    class ProgramCommand: pass
    class SerialUARTBaudRate: pass
    class PacketLength: pass
    class RegisterAddress: pass
